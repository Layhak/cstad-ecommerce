    ...
    return (
        <div className="mx-auto max-w-4xl px-4 py-8">
            ...
            <section className="mb-8">
                ...
                <p className="mb-3">
                    Our mission is to provide exceptional service and to follow
                    through on our promises. We will strive to deliver
                    individualized solutions to all our client printing needs
                    and add value to our client businesses. Our team is focused
                    on providing great service, great quality, and great value.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="mb-3">
                    ...
                    medium-sized businesses with their printing needs. From
                    business cards to corporate brochures, we strive to exceed
                    your expectations.
                </p>
            </section>
